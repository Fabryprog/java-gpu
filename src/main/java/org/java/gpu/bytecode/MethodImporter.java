...
package org.java.gpu.bytecode;

import org.java.gpu.debug.LinePropagator;
...
import org.java.gpu.graph.Annotation;
...
public class MethodImporter implements MethodVisitor {
  ...
  public void visitInsn(final int opcode) {
    ...
    switch(opcode) {
      ...
      case Opcodes.MONITORENTER: throw new RuntimeException("visitInsn: MONITORENTER");
      case Opcodes.MONITOREXIT:  throw new RuntimeException("visitInsn: MONITOREXIT");
      case Opcodes.DUP2_X1:      throw new RuntimeException("visitInsn: DUP2_X1");
      case Opcodes.DUP2_X2:      throw new RuntimeException("visitInsn: DUP2_X2");
      default:                   throw new RuntimeException("visitInsn: " + opcode);
    }
  }
