...
import org.java.gpu.util.WeakList;
...
public abstract class Block {
  ...
  /**
   * First line number that is associated with the code section (for debugging).
   */
   ...
   * <code>b</code>. For the abstract Block, this just checks the
  ...
  public String toString() {
    if(lineNumber != null) {
      return getClass().getSimpleName() + " #" + id + " (line "+lineNumber+")";
    } else {
